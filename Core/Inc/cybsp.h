...
/*----------   -----------*/
#define CYBSP_BT_POWER      PE15

/*----------   -----------*/
#define COMMAND_CONSOLE_UART_TX      PD8

/*----------   -----------*/
#define COMMAND_CONSOLE_UART_RX      PB11

/*----------   -----------*/
#define CYBSP_WIFI_HOST_WAKE      PD9

/*----------   -----------*/
#define CYHAL_ISR_PRIORITY_DEFAULT      7

/*----------   -----------*/
#define SDMMC_CLK_FREQ_OVERRIDE      100000000

/*----------   -----------*/
#define CYBSP_WIFI_WL_REG_ON      PE14

/*----------   -----------*/
#define CYBSP_BT_DEVICE_WAKE      PB15

/*----------   -----------*/
#define CYBSP_BT_HOST_WAKE      PB13
...
/*----------   -----------*/
#define CYBSP_BT_UART_RX      PA1

/*----------   -----------*/
#define CY_WIFI_COUNTRY      WHD_COUNTRY_UNITED_STATES

/*----------   -----------*/
#define CYBSP_BT_UART_RTS      PA15

/*----------   -----------*/
#define _CYHAL_SDIO_DMA_BUFFER_SIZE      5000
